...
Learn how to update your docs locally and deploy them to the public.ewkjfbjwlefbljefh
...
<CardGroup>
  <Card icon="file" href="/essentials/markdown" title="Add Content With MDX">
    Add content to your docs with MDX syntax.
  </Card>
  <Card icon="square-code" href="/essentials/code" title="Add Code Blocks">
    Add code directly to your docs with syntax highlighting.
  </Card>
  <Card icon="image" href="/essentials/images" title="Add Images">
    Add images to your docs to make them more engaging.
  </Card>
  <Card icon="puzzle-piece" href="/essentials/reusable-snippets" title="Add Custom Components">
